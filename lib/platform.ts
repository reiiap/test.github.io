...
export const coinPackages = [
  { name: "Starter", coins: "Konfigurasi", description: "Paket awal untuk mencoba satu atau beberapa Konversi kecil." },
  { name: "Builder", coins: "Konfigurasi", description: "Paket fleksibel untuk Resource Pack ukuran sedang." },
  { name: "Creator", coins: "Konfigurasi", description: "Paket lebih besar untuk creator yang sering melakukan Konversi." },
];

export const features = [
  { title: "Alur Konversi terpandu", description: "Unggah ZIP, pilih opsi, lalu pantau status dari dasbor akun yang aman." },
...
export const compatibility = [
  ...
  ["Model", "Opsi Konversi model akan ditambahkan bertahap sesuai engine."],
...
export const faqs = [
  ...
  ["Apakah harus login untuk mulai Konversi?", "Ya. Pengunjung bisa melihat informasi dan Harga Coin, tetapi proses Konversi berbayar akan membutuhkan akun."],
