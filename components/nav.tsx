    ...
    <header className="sticky top-0 z-50 border-b border-white/10 bg-[#050816cc] backdrop-blur-xl">
      <nav className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-5 py-4">
        ...
        <div className="hidden gap-6 text-sm text-slate-300 lg:flex">
          ...
          <Link href="/#harga-coin">Harga Coin</Link>
        ...
        <div className="flex items-center gap-2">
          {data?.user ? (
            <>
              <span className="hidden rounded-full border border-emerald-300/20 bg-emerald-300/10 px-3 py-2 text-xs text-emerald-100 sm:inline-flex">
                Saldo Coin: —
              </span>
