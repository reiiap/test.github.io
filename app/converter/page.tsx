...
export default async function Converter() {
  ...
  return <main className="section"><div className="glass rounded-[2rem] p-8"><p className="text-emerald-300">Konverter Resource Pack</p><h1 className="mt-3 text-5xl font-black">Java Edition → Bedrock Edition.</h1><p className="muted mt-4 max-w-3xl">Unggah Resource Pack ZIP, lihat hasil analisis, konfirmasi estimasi Coin dari server, lalu antrekan Conversion. Fase ini mendukung packaging Texture PNG ke format .mcpack dan menyertakan model Java sebagai referensi, bukan kompatibilitas penuh.</p></div><div className="mt-8"><ConverterClient /></div></main>;
}
