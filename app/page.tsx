...
export default function Home() {
  return (
    <main>
        ...
        <MotionShell className="glass relative overflow-hidden rounded-[2rem] p-6">
          ...
          <div className="relative grid gap-4 text-center">
            {[
              ...
              ["ReiiKajurawa JvsB", "Pilih opsi Conversion"],
      ...
      <section className="section"><h2 className="text-4xl font-black">Kompatibilitas Conversion</h2><div className="mt-8 grid gap-4 md:grid-cols-2">{compatibility.map(([k, v]) => <article className="glass rounded-3xl p-6" key={k}><h3 className="text-xl font-bold">{k}</h3><p className="muted mt-2">{v}</p></article>)}</div></section>
